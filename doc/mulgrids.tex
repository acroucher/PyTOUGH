...
\subsubsection{\texttt{layer\_plot(\emph{layer}, \emph{variable}=None, \emph{variable\_name}=None, \emph{unit}=None,\\
    ...
    \emph{wellcolour}=`blue', \emph{well\_names}=True, \emph{show\_outside\_wells}=True)}}
...
\item \textbf{well\_names}: Boolean or list (or \texttt{None})\\
  Specify \texttt{True} to label all wells with their names at the wellhead, \texttt{False} or \texttt{None} not to label them, or a list of wells or well names to label only particular wells.
