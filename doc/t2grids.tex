...
\begin{snugshade}
\subsubsection{\texttt{reorder(\emph{block\_names}, \emph{connection\_names}=\texttt{None})}}
\end{snugshade}
...
\textbf{Parameters:}
\begin{itemize}
\item \textbf{block\_names}: list of string\\
...
\item \textbf{connection\_names}: list of string (or \texttt{None})\\
  ...
  \texttt{None} (the default), connections are not reordered.
\end{itemize}
