...
\begin{table}
  \begin{center}
    \begin{tabular}{|l|l|p{65mm}|}
      ...
      \texttt{flux\_matrix} & \texttt{np.sparse.lil\_matrix} & constructs a sparse matrix for calculating block-average flows \\
